          ...
          <div className="text-center shadow-lg p-10 rounded-xl my-10 w-auto lg:w-[30%]">
            <Link href="/projects/Custom Software Development">
              ...
              <p className="py-2 dark:text-gray-200">
                ...
                your software is scalable, secure, and optimized for
                performance, helping you stay ahead of the competition.
              </p>
            </Link>
          </div>
          ...
          <div className="text-center shadow-lg p-10 rounded-xl my-10 w-auto lg:w-[30%]">
            <Link href="/projects/Automation and AI">
              ...
              <p className="py-2 dark:text-gray-200">
                ...
                repetitive tasks, make data-driven decisions, and provide
          ...
          <div className="text-center shadow-lg p-10 rounded-xl my-10 w-auto lg:w-[30%]">
            <Link href="/projects/Branding Services Description">
              ...
              <p className="py-2 dark:text-gray-200">
                ...
                out across all platforms. Let’s create a brand that resonates
                and drives growth.
              </p>
            </Link>
          </div>
          <div className="text-center shadow-lg p-10 rounded-xl my-10  w-auto lg:w-[30%]">
            <Link href="/projects/Web and Mobile Applications">
              ...
              <p className="py-2 dark:text-gray-200">
                ...
                that deliver seamless experiences across all devices. Whether
                you need a robust e-commerce platform, a dynamic web portal, or
                a cutting-edge mobile app, I’ve got you covered.
              </p>
            </Link>
          </div>
          ...
          <div className="text-center shadow-lg p-10 rounded-xl my-10  w-auto lg:w-[30%]">
            <Link href="/projects/Tech and IT consultation">
              ...
              <p className="py-2 dark:text-gray-200">
                ...
                complexities of technology adoption and digital transformation.
                We provide strategic advice, risk management, and implementation
