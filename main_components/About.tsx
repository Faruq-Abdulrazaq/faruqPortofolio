...
const About = () => {
  return (
    <section className="w-full flex flex-col justify-center lg:flex-row lg:items-center">
      <div className="w-auto h-auto lg:h-[550px] lg:w-[50%] mt-0 flex justify-center items-center text-black lg:mt-5">
        <div className="w-[70%] h-[100%] bg-faruq_primary opacity-60 p-2  flex flex-col gap-5 justify-center items-center rounded-xl shadow-lg">
      ...
      <div className="w-[auto] lg:w-[50%] h-auto lg:h-[500px] flex flex-col gap-2 justify-center items-center lg:items-start">
        <div className="flex gap-3 flex-col mt-5 w-[70%] h-[100%] lg:w-full lg:mt-5">
          <h2 className="text-[30px] lg:text-[50px] font-bold">About me</h2>
          <p className="text-[10px] lg:text-[20px] w-auto lg:max-w-[80%]">
